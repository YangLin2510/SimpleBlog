                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" alt="Third slide [800x400]"
                    ...
                    <#list recommendBlogs as blog>
                        <li>
                            <div style="padding:16px;">
                                <p style="font-size:large;"><a href="/blog?articalId=${blog.id}"
                                                               style="font-weight: bold;">${blog.title} </a><span
                                        style="float:right;color:#81C8F1;">${blog.viewCount}</span></p>
                                <div style="font-size:small;color:#999999"><span><a href="/?tagCode=${blog.blogTagCode}"
                                                                                    style="color:#007bff;padding-right:32px;">${blog.blogTypeName}</a></span>
                                    <span><a
                                            href="/viewBolgsWithAuthor?blogAuthorId=${blog.authorUserId}">${blog.authorUserName}</a></span><span
                                            style="padding-left:16px;">${blog.createTime?datetime}</span> <span
                                            style="float:right">阅读量</span></div>
                            </div>
                        </li>
