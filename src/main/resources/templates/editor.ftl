 ...
 <div id="editor_container" class="col-10">
   <div class="row">
    ...
    <div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
        <div class="btn-group">
            <a class="btn dropdown-toggle" data-toggle="dropdown" title="字体" id="Font"><i class="icon-font"></i></a>
            <ul class="dropdown-menu">
            </ul>
        </div>
        <div class="btn-group">
            <a class="btn dropdown-toggle" data-toggle="dropdown" title="字体大小"><i class="icon-text-height"></i>&nbsp;</a>
            <ul class="dropdown-menu">
        ...
        <div class="btn-group">
            ...
            <a class="btn" data-edit="justifyfull" title="整理版面 (Ctrl/Cmd+J)"><i class="icon-align-justify"></i></a>
        </div>
        <div class="btn-group">
